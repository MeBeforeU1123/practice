...
<head>
    ...
    <style type="text/css" >
        #vipNav a.on{color:#fff;background:#B0C4DE;}
        #vipNav a:hover{color:#fff;background:#B0C4DE;}
    </style>
</head>
<body>
            ...
            <form action="${ctx}/user/exUpdate" method="post" id="myf">
                <div class="hidden_yh bj_fff" style="width: 938px;border: 1px solid #ddd;">
                    ...
                    <div class="width100" style="height: 32px;line-height: 32px;margin-top: 70px;">
                        <a href="javascript:void(0)" class="left_yh block_yh font16 tcenter ff5802 sub" style="width: 244px;height: 33px;line-height: 33px;margin-left: 120px;background:#B0C4DE;">保存</a>
                    </div>
