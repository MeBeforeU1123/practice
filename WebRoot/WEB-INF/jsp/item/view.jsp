...
<head>
    ...
    <style type="text/css">
        #spXqpj a.on{background:#B0C4DE;color:#fff;}
    </style>
</head>
<body>
...
<div class="width1198 center_yh" style="height: 420px;">
    ...
    <div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
        ...
        <div class="buyFor">
            <a href="${ctx}/sc/exAdd?itemId=${obj.id}" class="mstBuy" style="background: #B0C4DE">收藏</a>
            <a href="javascript:void(0)" class="addCar" style="background: #B0C4DE">加入购物车</a>
        </div>
    </div>
</div>
