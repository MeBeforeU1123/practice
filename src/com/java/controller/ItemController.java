...
public class ItemController extends BaseController {
    ...
    public String exAdd(Item item, @RequestParam(value = "file",required = false)CommonsMultipartFile[] files, HttpServletRequest request) throws IOException {
//        System.out.println("------------------------------------------------------------------"+item);
    ...
    public String exUpdate(Item item, @RequestParam(value = "file",required = false)CommonsMultipartFile[] files, HttpServletRequest request) throws IOException {
        itemCommon(item, files, request);
     ...
     * 新增和更新的公共方法
     */
    private void itemCommon(Item item, @RequestParam(value = "file",required = false) CommonsMultipartFile[] files, HttpServletRequest request) throws IOException {
        if(files.length>0) {
